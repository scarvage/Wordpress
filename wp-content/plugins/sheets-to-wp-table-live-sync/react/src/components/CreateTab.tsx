				...
				<ul className="navbar-step__tab-list">
					<li className={`${activeTab === 'manage_tab' ? 'active' : ''}`}>
						<a onClick={() => handleActiveTab('manage_tab')}>
							...
							<span className="text">{getStrings('managing-tabs')}</span>
						</a>
					</li>
					...
					<div className="table-action__group">
						<div className={`table-action__dropdown ${openDropdown ? 'show' : ''}`}>
							<div className="action-group">
								<button onClick={handleCreateTab} className="table-action__save">{getStrings('save-and-update')}</button>
							...
							<div className="table-action__dropdown-menu" onClick={handleCreateTabandRedirect}>
