...
class Graphina_Charts_For_Elementor
{
    ...
    private function define_elementor_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_get_jquery_datatable_data', $plugin_public, 'action_get_jquery_datatable_data');
        $this->loader->add_action('wp_ajax_nopriv_get_jquery_datatable_data', $plugin_public, 'action_get_jquery_datatable_data');
    }
