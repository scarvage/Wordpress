                    ...
                    legend: {
                        ...
                        formatter: function(seriesName, opts) {
                            if('<?php echo !empty($settings['iq_' . $type . '_chart_legend_show_series_value']) && $settings['iq_' . $type . '_chart_legend_show_series_value'] === 'yes' ?>'){
                                let prefix = '<?php echo isset($settings[ 'iq_' . $type . '_chart_legend_show_series_prefix'] )  && $settings[ 'iq_' . $type . '_chart_legend_show_series_prefix'] =="yes" && !empty($settings[ 'iq_' . $type . '_chart_datalabel_format_prefix']) ? $settings[ 'iq_' . $type . '_chart_datalabel_format_prefix'] : '' ?>'
                                let postfix = '<?php echo isset($settings[ 'iq_' . $type . '_chart_legend_show_series_postfix'] )  && $settings[ 'iq_' . $type . '_chart_legend_show_series_postfix'] =="yes" && !empty($settings[ 'iq_' . $type . '_chart_datalabel_format_postfix' ]) ? $settings['iq_' . $type . '_chart_datalabel_format_postfix'] : '' ?>'
