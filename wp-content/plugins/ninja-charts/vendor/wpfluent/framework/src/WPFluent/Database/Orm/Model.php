...
use NinjaCharts\Framework\Support\UrlRoutable;
use NinjaCharts\Framework\Database\Orm\DateTime;
use NinjaCharts\Framework\Foundation\Dispatcher;
use NinjaCharts\Framework\Support\QueueableEntity;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable, QueueableEntity, UrlRoutable
{
	 ...
	 *
	 * @var \NinjaCharts\Framework\Database\ConnectionResolverInterface
	 */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Eloquent\Scope|\Closure|string  $scope
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Eloquent\Scope|string  $scope
     * @return bool
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Eloquent\Scope|string  $scope
     * @return \NinjaCharts\Framework\Database\Eloquent\Scope|\Closure|null
     */
     ...
     * @return $this
     *
     * @throws \NinjaCharts\Framework\Database\Eloquent\MassAssignmentException
     */
     ...
     * @param  array  $items
     * @param  string|null  $connection
     * @return \NinjaCharts\Framework\Database\Eloquent\Collection
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Eloquent\Builder
     */
     ...
     * @return \NinjaCharts\Framework\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  array|string  $relations
     * @return \NinjaCharts\Framework\Database\Eloquent\Builder|static
     */
     ...
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\HasOne
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\MorphOne
     */
     ...
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\BelongsTo
     */
     ...
     * @param  string  $type
     * @param  string  $id
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\MorphTo
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\HasMany
     */
     ...
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\HasManyThrough
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\MorphMany
     */
     ...
     * @param  string  $otherKey
     * @param  string  $relation
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\BelongsToMany
     */
     ...
     * @param  string  $otherKey
     * @param  bool  $inverse
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\MorphToMany
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Eloquent\Builder  $query
     * @param  array  $options
     * @return bool
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Orm\DateTime
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @return \NinjaCharts\Framework\Database\Eloquent\Relations\Pivot
     */
    ...
    protected function getRelationshipFromMethod($method)
    {
        ...
        if (! $relations instanceof Relation) {
            throw new LogicException('Relationship method must return an object of type '
                .'NinjaCharts\Framework\Database\Eloquent\Relations\Relation');
        }
     ...
     * @return \NinjaCharts\Framework\Database\Eloquent\Model
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\Connection
     */
     ...
     *
     * @return \NinjaCharts\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \NinjaCharts\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     *
     * @return \NinjaCharts\Framework\Contracts\Events\Dispatcher
     */
