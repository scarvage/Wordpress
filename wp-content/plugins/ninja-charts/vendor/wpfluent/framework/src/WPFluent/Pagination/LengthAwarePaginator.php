...
namespace NinjaCharts\Framework\Pagination;
...
use NinjaCharts\Framework\Pagination\Presenter;
use NinjaCharts\Framework\Pagination\Paginator;
use NinjaCharts\Framework\Pagination\AbstractPaginator;
use NinjaCharts\Framework\Pagination\LengthAwarePaginatorInterface;
...
class LengthAwarePaginator extends AbstractPaginator implements ArrayableInterface, ArrayAccess, Countable, IteratorAggregate, JsonSerializable, JsonableInterface, LengthAwarePaginatorInterface
{
     ...
     *
     * @param  \NinjaCharts\Framework\Pagination\Presenter|null  $presenter
     * @return string
     */
